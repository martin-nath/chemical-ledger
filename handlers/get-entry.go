...
// 	if filters.Transactions == "basedOnDates" {
// 		return `
// 					SELECT
// 						e.id,
// 						e.type,
...
// func validateCompoundIdField(compoundId string) utils.ErrorMessage {

// 	if compoundId != "all" {
// 		compoundExists, err := utils.CheckIfCompoundExists(compoundId)
// 		if err != nil {
